        ...
        <div className="wrapper fancypants">
            ...
            <section className='about' id='about'>
                ...
                <div className='about__details'>
                    ...
                    <p>Currently, I am a Senior UI Developer for a global tech company migrating a legacy management console to a single-page application using TypeScript, React, and GraphQL.</p>
